    ...
    do{
        ...
        do{
            ...
            switch(cod) {
                ...
                case 7: totalPedido = totalPedido + (5.50*qnt); break;
                case 8: totalPedido = totalPedido + (5.50*qnt); break;
                case 9: totalPedido = totalPedido + (5.50*qnt); break;
                case 10: totalPedido = totalPedido + (6.00*qnt); break;
                case 11: totalPedido = totalPedido + (12.00*qnt); break;
                case 12: totalPedido = totalPedido + (9.00*qnt); break;
                case 13: totalPedido = totalPedido + (9.00*qnt); break;
                case 14: totalPedido = totalPedido + (8.50*qnt); break;
                case 15: totalPedido = totalPedido + (3.50*qnt); break;
                case 16: totalPedido = totalPedido + (3.50*qnt); break;
                case 17: totalPedido = totalPedido + (3.50*qnt); break;
                case 18: totalPedido = totalPedido + (5.00*qnt); break;
            }
